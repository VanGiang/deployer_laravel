function onload(event) {
    ...
    //     }
    // });
    var rateList = $(".rater-step");

    $.each( rateList, function( key, rateElement ) {
        var player_id = $(this).attr('player_id');
        var pointCol = $(this).parent().parent().find('.point-col');
        var pointAvgOld = parseFloat(pointCol.text());
        console.log(pointAvgOld);
