                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('match.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control form-control-sm @error('name') is-invalid @enderror" name="type">
                                    <option value="1">Noi bo</option>
                                    <option value="2">Giao huu</option>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Stadium') }}</label>
